...
function affichage_image() {
  for (var i = 0; i < nb_question; i++) {
    document.getElementById("question_image_"+i).innerHTML += '<img class="transistor_img"src= '+ transistor[i].img +' alt="Photo de T3" title="T3" /> ';
    create_rolling_menu();
  }
}
...
function create_rolling_menu() {
  for (var i = 0; i < nb_question; i++) {
    document.getElementById("rolling_menu_"+i).innerHTML += create_listing_menu();
  }
}
